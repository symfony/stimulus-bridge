...
function getLoaderOptions(loaderContext) {
	...
	if (Object.prototype.hasOwnProperty.call(loaderUtils, "getOptions")) return loaderUtils.getOptions(loaderContext);
...
//#endregion
export { lazy_controller_loader_default as default };